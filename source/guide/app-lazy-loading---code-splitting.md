...
Easy, right? What this does is that it creates a separate chunk for `/src/pages/SomePage.vue` which can be loaded only when it is needed. In this case, when user visits the '/some-page' route.
